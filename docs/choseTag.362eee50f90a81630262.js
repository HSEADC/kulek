...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function filterCards() {
    var cards = document.querySelectorAll('.M_LongCardMainLink');
    cards.forEach(function (card) {
      var tagsInCard = Array.from(card.querySelectorAll('.W_tagsCardsArticles .A_subTagNewMain p')).map(function (p) {
        return p.innerText;
      });
