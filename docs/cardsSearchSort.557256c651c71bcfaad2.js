...
var M_cardSearch = function M_cardSearch(_ref) {
  var srcImg = _ref.srcImg,
      tags = _ref.tags,
      nameCard = _ref.nameCard,
      descCard = _ref.descCard,
      url = _ref.url;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", {
    href: url
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "M_cardSearch"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", {
    src: srcImg,
    alt: "\u041A\u0430\u0440\u0442\u0438\u043D\u043A\u0430 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",
    className: "A_pictureCardSearch"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "W_allTextSearch"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "M_tagsType"
  }, tags.map(function (tag, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      key: index,
      className: "A_tagButton"
    }, "#", tag);
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", {
    className: "A_nameArticleSearch"
  }, nameCard), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", {
    className: "A_subArticleSearch"
  }, descCard))));
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (M_cardSearch);
...
// EXTERNAL MODULE: ./src/components/M_cardSearch/M_cardSearch.jsx
var M_cardSearch = __webpack_require__(9945);
...
;// CONCATENATED MODULE: ./src/javascript/searchData.js

var token = 'patriREkQ3HCJxKvY.f7aa3a52ce62d2b0d406f6092755d36c5a79b01a636e7473d45dcfb69cc1fe8e';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('app6JZx3xMLq29n1Z');
...
;// CONCATENATED MODULE: ./src/javascript/cardsSearchSort.jsx
...
var getSearchInputValue = function getSearchInputValue() {
  var url = new URL(window.location.href);
  var searchParams = new URLSearchParams(url.search);
  return searchParams.get('q') || '';
};

var cardsSearchSort_decodeHTMLEntities = function decodeHTMLEntities(text) {
  var textarea = document.createElement('textarea');
  textarea.innerHTML = text;
  return textarea.value;
};
...
var S_SearchContent = function S_SearchContent(_ref) {
  ...
  var filterArticles = function filterArticles(articles, query) {
    var lowercasedQuery = query.toLowerCase();
    var nbspRegex = /[\u202F\u00A0]/gm;
    var punctuationRegex = /[.,\/#!$%\^&\*;:{}=\-_`~()]/gm;
    var filtered = articles.filter(function (article) {
      var title = cardsSearchSort_decodeHTMLEntities(article.title).replace(nbspRegex, ' ').replace(punctuationRegex, '').toLowerCase();
      var description = cardsSearchSort_decodeHTMLEntities(article.description).replace(nbspRegex, ' ').replace(punctuationRegex, '').toLowerCase();
  ...
  var updateHeader = function updateHeader(query, articleCount) {
    var header = document.querySelector('.A_nameSearch');

    if (header) {
      var totalCount = articleCount;
      header.textContent = "\u041F\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0443 \"".concat(query, "\" \u043D\u0430\u0448\u043B\u043E\u0441\u044C ").concat(totalCount, " \u043C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u043E\u0432");
    }
  };

  return /*#__PURE__*/react.createElement(react.Fragment, null, filteredArticles.map(function (article) {
    return /*#__PURE__*/react.createElement(M_cardSearch/* default */.Z, {
      nameCard: /*#__PURE__*/react.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: article.title
        }
      }),
      descCard: /*#__PURE__*/react.createElement("span", {
        dangerouslySetInnerHTML: {
...
var searchInputValue = getSearchInputValue();
var container = document.querySelector('.O_allCardsSearch');
